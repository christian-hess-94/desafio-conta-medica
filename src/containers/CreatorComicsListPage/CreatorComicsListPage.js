...
class CreatorComicsListPage extends Component {
    ...
    componentDidMount() {
        ...
        marvelInstance.get(`/v1/public/creators/${this.props.match.params.id}/comics?ts=1&apikey=24f5858e2b4667852c2576f8c1477b9e&hash=48836ab485d1e75d8a06e5c4bece9731`)
        .then(res=>{
            // console.log("Quadrinhos do creator", res.data.data.results)
            this.setState({comics: res.data.handleGoToComicDetails.results})
        })
        .catch(error=>{
...
export default CreatorComicsListPage
